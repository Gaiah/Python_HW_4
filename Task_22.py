...
print(li := sorted(list(set([input('a[i]: ') for i in range(0, int(input('Input N for the first set: ')))])
                  .intersection(set([input('b[i]: ') for i in range(0, int(input('Input N for the second set: ')))])))))
